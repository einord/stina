...
**Test count**: 534 tests pass (520 prior + 14 new — 13 unit tests for `deriveLinkedEntities` + 1 expanded integration assertion). **Typecheck**: clean across all packages and apps.

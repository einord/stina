...
**Layering note (redesign-2026):** `threads`, `memory`, `autonomy` form a stack the `chat` orchestrator consumes. They cannot reach back into `chat` — that would invert the layer. See [docs/redesign-2026/08-migration.md](./docs/redesign-2026/08-migration.md) §"Package decomposition".

const en = {
  ...
  extensions: {
    ...
    link_local_title: 'Link Local Extension',
    link_local_description: 'Enter the absolute path to an extension folder.',
    link_local_path_label: 'Extension Path',
    link_local_path_placeholder: '/path/to/extension',
    link_local_path_hint: 'The folder must contain a valid extension manifest.',
    link_local_warning: 'Local extensions are not verified and run at your own risk.',
    link_local_confirm: 'Link',
    local_badge: 'Local',
    unlink: 'Unlink',
